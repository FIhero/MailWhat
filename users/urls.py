...
urlpatterns = [
    ...
    path('password-reset/code/<str:email>/', views.enter_verification_code, name='enter_code'),
    path('password-reset/new-password/<int:user_id>/', views.new_password, name='new_password'),
