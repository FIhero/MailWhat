...
from .models import User, UserProfile, LectorProfile, ManagerProfile


@admin.register(User)
class CustomUserAdmin(UserAdmin):
    list_display = ('email', 'first_name', 'last_name', 'role', 'get_groups', 'is_blocked', 'is_active')
    ...
    fieldsets = (
        ...
        ('Permissions',
         {'fields': ('role', 'is_blocked', 'is_active', 'is_staff', 'is_superuser', 'groups', 'user_permissions')}),
