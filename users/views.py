...
from django.views.generic import CreateView, DeleteView, DetailView, UpdateView, ListView, FormView, TemplateView
    ...
    if request.method == 'POST':
        ...
        if email in verification_codes:
            ...
            if entered_code == stored_code:
                ...
                return render(request, 'users/code_verification.html', {
                    'email': email,
                    'error': 'Неверный код'
                })
        else:
            return render(request, 'users/code_verification.html', {
                'email': email,
                'error': 'Код устарел или не существует'
            })
